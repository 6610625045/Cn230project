...
def analyze_data_with_sql(db_name="stock_data.db"):
    ...
    print("\n2.วันที่ที่มีปริมาณการซื้อขายสูงสุด 3 อันดับแรก:")
    ...
    print("\n3.วันที่ที่มีช่วงราคาสูงสุด 3 อันดับแรก:")
...
def analyze_data_with_sql_extended(db_name="stock_data.db"):
    ...
    print(f"\n4.วันที่ที่มีราคาปิดสูงสุด: {highest_close[0]}, ราคา: {highest_close[1]:.2f}")
    ...
    print(f"5.วันที่ที่มีราคาปิดต่ำสุด: {lowest_close[0]}, ราคา: {lowest_close[1]:.2f}")
    ...
    print(f"\n6.ค่าเฉลี่ยของปริมาณการซื้อขาย: {average_volume:.0f}")
    ...
    print(f"\n7.จำนวนวันที่ราคาปิดสูงกว่าราคาเปิด: {days_close_higher_than_open} วัน")
    ...
    print(f"8.จำนวนวันที่ราคาปิดต่ำกว่าราคาเปิด: {days_close_lower_than_open} วัน")
    ...
    print(f"\n9.วันที่ที่มีความผันผวนของราคาสูงสุด (high/low): {most_volatile_day[0]}, อัตราส่วน: {most_volatile_day[1]:.2f}")
